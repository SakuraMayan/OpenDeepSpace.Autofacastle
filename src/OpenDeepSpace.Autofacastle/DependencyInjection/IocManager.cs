using Autofac;
using OpenDeepSpace.Autofacastle.DependencyInjection.Enums;
using System;
...
namespace OpenDeepSpace.Autofacastle.DependencyInjection
{
    ...
    public class IocManager
    {
        ...
        /// <param name="Keyed"></param>
        /// <returns></returns>
        public static TService TryResolve<TService>(object Keyed)
        {
            if (Container == null)
                throw new ArgumentException(nameof(Container));
            if (Keyed == null)
        ...
        /// <returns></returns>
        public static TService Resolve<TService>(string Named)
        {
            if (Container == null)
                throw new ArgumentException(nameof(Container));
            if (Named == null)
        ...
        /// <param name="Named"></param>
        /// <returns></returns>
        public static TService TryResolve<TService>(string Named)
        {
            if (Container == null)
                throw new ArgumentException(nameof(Container));
            if (Named == null)
