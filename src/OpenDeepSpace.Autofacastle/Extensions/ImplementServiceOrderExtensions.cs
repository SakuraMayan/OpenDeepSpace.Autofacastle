...
namespace OpenDeepSpace.Autofacastle.Extensions
{
    ...
    public static class ImplementServiceOrderExtensions
    {
        ...
        /// <returns></returns>
        public static TService GetMinImplementServiceOrderService<TService>(this IEnumerable<TService> services) where TService : IImplementServiceOrder
        {
        ...
        /// <param name="services">服务集合</param>
        /// <returns></returns>
        public static TService GetMaxImplementServiceOrderService<TService>(this IEnumerable<TService> services) where TService : IImplementServiceOrder
        {
        ...
        /// <returns></returns>
        public static TService GetAppointImplementServiceOrderService<TService>(this IEnumerable<TService> services, int implementServiceOrder) where TService : IImplementServiceOrder
        {
